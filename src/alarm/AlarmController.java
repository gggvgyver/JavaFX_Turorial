...
public class AlarmController {
    ...
    public AlarmController(AlarmModel model) { this.alarmModel = model; }
    ...
    public void onAdd() { alarmModel.addAlarm( new Alarm(LocalTime.now().plusSeconds(5))); }
    ...
    public void onExit() { alarmModel.stop(); }
}
